...
function PricingSection() {
  return (
    <section className="mt-24 mb-28 px-36 max-1300:px-24 max-900:px-18 min-w-96-bg">
      {/* Title */}
      ...
      <div className="flex justify-around">
        ...
        <div className="flex flex-col justify-between shadow-md font-gilroy w-[350px] h-[540px] p-9 rounded-3xl">  
          <div className="flex flex-col justify-start gap-6">
            ...
            <div className="flex items-center justify-start gap-3">
              <img className="w-16 h-16" src={pricingImage} alt="Pricing image" />
              <h3 className="text-3xl font-semibold text-main">Basic Plan</h3>
            </div>
        ...
        <div className="flex flex-col relative text-white justify-between shadow-md font-gilroy w-[350px] h-[540px] bg-[#B772FF] pricing-bg p-9 rounded-3xl">  
          <div className="flex flex-col justify-start gap-6">
            ...
            <div className="flex items-center justify-start h-16 gap-3">
              <h3 className="text-4xl font-semibold text-white">Premium Plan</h3>
            </div>
        ...
        <div className="flex flex-col justify-between shadow-md font-gilroy w-[350px] h-[540px] p-9 rounded-3xl">  
          <div className="flex flex-col justify-start gap-6">
            ...
            <div className="flex items-center justify-start gap-3">
              <img className="w-16 h-16" src={pricingImage} alt="Pricing image" />
              <h3 className="text-3xl font-semibold text-main">Ultimate Plan</h3>
            </div>
